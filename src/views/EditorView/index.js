...
import * as uiActions from '@/actions/uiAction';
import { widgets, colormap, backgroundColor, editMode, chartMode } from '@/selectors/canvas';
import { displayFlag, isLoading, colorsetType, colorsetIndex } from '../../selectors/canvas';
// import { editMode, chartMode } from '../../../src2/selectors/canvas';
...
const mapStateToProps = state => {
    return {
        ...
        colorsetType: colorsetType(state),
        colorsetIndex: colorsetIndex(state),
...
const mapDispatchToProps = dispatch => {  
    return {
        ...
        changeColorset:(colorsetType, colorsetIndex) =>dispatch(canvasActions.changeColorset(colorsetType, colorsetIndex)),
