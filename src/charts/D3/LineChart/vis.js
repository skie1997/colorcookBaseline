...
const draw = (props) => {
    ...
    if (hasSeries) {
        ...
        // maxValue = d3.max(data.map(d=>d[encoding.y.field]));
    ...
    console.log('line-datavalue',dataValue)
    let minValue = d3.min(dataValue);
    let maxValue = d3.max(dataValue);
    let midValue = d3.mean(dataValue);
    ...
    //     computeColor = d3.interpolate(colorList[0], colorList[1]);
    ...
    //         .range([colorList[0], colorList[1],colorList[2]])
    // }else{
        ...
        for (let index = 0; index < series.length; index++) {
            ...
            group.append('path')
                ...
                .attr('stroke', function(d,i) {
                    ...
                    //     return computeColor(valueScale(dataValue[index]))
                    // }else if(colorset.length == 3){
                    //     return computeColor(dataValue[index])
                    // }
                    // else{
                        return globalColorscale(d[0].color)
                    // }
            ...
            group.selectAll('.dot')
                ...
                .style("stroke", function(d,i) {
                    ...
                    // }
                    // else{
                        return globalColorscale(d.color)
                    // }
